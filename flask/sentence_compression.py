...
def build_dict(model_name):
	with open("./word_dictionary/%s.pickle"%(model_name), "rb") as f:
...
def build_dataset(sentences, word_dict, article_max_len, summary_max_len):

	article_list = [ clean_str(sent.strip()) for sent in sentences]
